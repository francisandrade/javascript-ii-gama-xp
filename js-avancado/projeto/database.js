// Um Array de livros (objetos) simulando um JSON de livros
const livros = [
    {
        id: 1,
    ...
    {
        id: 2,
        nome: "O Genocódio do negro brasileiro",
...
// O Node JS nos possibilita exportar os nossos dados, funções, qualquer sintaxe p usar em outro arquivo
